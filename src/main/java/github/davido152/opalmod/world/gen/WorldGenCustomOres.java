...
{
	private WorldGenerator opal_ore, fire_opal_ore, nether_fire_opal_ore, matrix_opal_ore, diamond_ore, big_opal_ore;
	...
	public WorldGenCustomOres()
	{
		...
		big_opal_ore = new WorldGenMinable(ModBlocks.OPAL_ORE.getDefaultState(), 20, BlockMatcher.forBlock(Blocks.STONE));
	}
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) 
	{
		switch (world.provider.getDimension())
		{
			case -1:
				...
				runGenerator(nether_fire_opal_ore, world, random, chunkX, chunkZ, 6, 8, 250);
				
				break;
			
			case 0:
				
				runGenerator(opal_ore, world, random, chunkX, chunkZ, 3, 9, 26);
				runGenerator(fire_opal_ore, world, random, chunkX, chunkZ, 2, 5, 20);
				runGenerator(matrix_opal_ore, world, random, chunkX, chunkZ, 1, 13, 18);
