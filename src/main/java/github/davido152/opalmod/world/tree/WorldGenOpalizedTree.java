package github.davido152.opalmod.world.tree;
...
public class WorldGenOpalizedTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = ModBlocks.OPALIZED_WOOD_LOG.getDefaultState();
	public static final IBlockState LEAF = ModBlocks.OPALIZED_WOOD_LEAVES.getDefaultState();
