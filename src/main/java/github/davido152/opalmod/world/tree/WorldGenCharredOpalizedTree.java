...
public class WorldGenCharredOpalizedTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = ModBlocks.CHARRED_OPALIZED_WOOD_LOG.getDefaultState();
	
	private final int minHeight;
	
	public WorldGenCharredOpalizedTree() 
	{
		super(false);
		this.minHeight = 1;
	}
