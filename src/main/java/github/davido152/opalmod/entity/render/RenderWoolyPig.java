...
{
	public static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/entity/wooly_pig/wooly_pig.png");
	
	public RenderWoolyPig(RenderManager manager) 
	{
		super(manager, new ModelWoolyPig(), 0.5f);		
		this.addLayer(new LayerWoolyPigWool(this));
	}
