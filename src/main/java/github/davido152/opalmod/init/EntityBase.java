...
{   
    public static void registerEntities()
	{
		...
		registerEntity("kaprosuchus", EntityKaprosuchus.class, Reference.ENTITY_KAPROSUCHUS, 50, 6636321, 13789470);
		...
		EntityRegistry.addSpawn(EntityKaprosuchus.class, 30, 1, 4, EnumCreatureType.CREATURE, Biome.getBiome(1));
	}
