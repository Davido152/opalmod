...
{	
	...
	public ContainerPurifier(InventoryPlayer player, TileEntityPurifier tileentity) 
	{
		...
		this.addSlotToContainer(new SlotItemHandler(handler, 0, 32, 17));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
		...
		if(slot != null && slot.getHasStack()) 
		{
			...
			{		
				...
				if(!PurifierRecipes.getInstance().getPurifierResult(stack1, slot1.getStack()).isEmpty())
				{
					if(!this.mergeItemStack(stack1, 0, 2, false)) 
					{
						return ItemStack.EMPTY;
					}
					else if(TileEntityPurifier.isItemFuel(stack1))
					{
